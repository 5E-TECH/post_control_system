          ...
          {!hideSend && (
            <div className="px-4 py-4 border-t border-gray-100 dark:border-gray-700/50 flex-shrink-0">
              <button
                ...
                onClick={handleClick}
                className="w-full px-6 py-4 bg-gradient-to-r from-red-500 to-rose-600 text-white rounded-xl font-semibold text-base hover:shadow-lg hover:shadow-red-500/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isPending ? (
