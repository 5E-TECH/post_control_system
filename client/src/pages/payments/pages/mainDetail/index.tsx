      ...
      <div>
        ...
        <div className="mt-10">
          <div className="flex justify-around w-[80%]">
            <button onClick={() => setShowCurier(true)} className="border py-2 px-3 rounded-md text-white bg-[#9d70ff]">
              Kuriyerdan olish
            </button>
            <button onClick={() => setShowMarket(true)} className="border py-2 px-3 rounded-md text-white bg-[#9d70ff]">
              Marketga to'lash
            </button>
          </div>
          <div>
