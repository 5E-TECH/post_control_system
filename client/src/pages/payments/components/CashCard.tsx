...
export const CashboxCard = ({ raw, show, setShow }: Props) => {
  return (
    <div>
      <div className="w-[500px] max-[550px]:w-[100%] h-[250px] px-6 py-6 text-2xl flex flex-col rounded-[20px] bg-gradient-to-r from-[#041464] to-[#94058E] text-white justify-between relative">
        ...
        <div className="flex flex-col">
          ...
          <div>
            <h2 className="font-bold text-[25px] text-[#ede8ff88] max-md:text-[20px]">
              1234 5678 8765 4321
            </h2>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <p className="text-[40px] font-medium w-[300px] max-md:text-[30px]">
            {show ? (
