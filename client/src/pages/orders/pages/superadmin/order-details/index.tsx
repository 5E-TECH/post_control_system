...
import Details from "../../components/orderDetails/index";
      ...
      <div className="ml-6 flex  items-center justify-between mr-6">
        <div>
          <div className="flex flex-row gap-2.5 items-center">
            <h2 className="text-[18px] text-[#2E263DE5] dark:text-[#E7E3FCE5]">Order #32543</h2>
          ...
          <div>
            <h2 className="text-[15px] text-[#2E263DB2] dark:text-[#E7E3FCB2]">Aug 17, 2020, 5:48 (ET)</h2>
          </div>
        </div>
        <div>
          <button className="border px-[18px] py-[8px] rounded-md border-[#FF4C51] text-[#FF4C51] text-[15px]">Delete Order</button>
        </div>
      </div>
