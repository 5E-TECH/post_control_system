                ...
                {isLoading ? (
                  ...
                  <tbody>
                    {markets?.map((market: any) => (
                      ...
                      >
                        <td className="data-cell max-[254px]:w-full h-[56px] pl-[20px] text-left" data-cell="MARKET NOMI">
                        ...
                        <td className="data-cell max-[254px]:w-full h-[56px] pl-[20px] text-left max-[254px]:" data-cell="TELEFON NOMERI">
