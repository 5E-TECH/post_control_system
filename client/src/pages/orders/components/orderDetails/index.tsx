import { createContext, memo, useMemo, useState, type FC } from "react";
...
const Details: FC<IProps> = ({
  ...
  const handlesubmit = () => {
    ...
    if (delevery !== deleveryStatus) {
      payload.where_deliver = delevery;
    }
    ...
    if (!isSame) {
      payload.order_item_info = currentItems;
    }

    // Agar hech narsa o'zgarmagan bo'lsa request yubormaymiz
