  ...
  return (
    <div>
      ...
      <div className="mx-5 mb-6 flex gap-3 flex-col text-[15px] text-[#E7E3FCB2] dark:text-[#E7E3FCE5]">
        <Info text={"Contact info"} path="/orders/customer/detail" className={"text-[15px] dark:text-[#E7E3FCE5]"}/>
        <div>
            <h2 className="text-[#2E263DB2] dark:text-[#E7E3FCB2]">Phone Number: +998913607434</h2>
        </div>
      </div>
    </div>
  );
