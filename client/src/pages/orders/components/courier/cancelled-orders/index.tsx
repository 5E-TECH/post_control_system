...
const CancelledOrders = () => {
  ...
  const handleClick = () => {
    ...
    cancelPost(payload, {
      onSuccess: () => {
        api.success({
          message: "Buyurtmalar muvaffaqiyatli qaytarildi",
          placement: "topRight",
        });
        refetch();
      },
      onError: (error: any) => {
        ...
        switch (statusCode) {
          case 400:
            description =
              "So‘rov noto‘g‘ri yuborildi. Iltimos, ma’lumotlarni tekshiring.";
            break;
          case 401:
            description =
              "Avtorizatsiya talab qilinadi. Iltimos, tizimga qayta kiring.";
            break;
          case 403:
            description =
              "Sizda ushbu amalni bajarish uchun yetarli huquqlar yo‘q.";
            break;
          case 404:
          ...
          case 503:
            description =
              "Xizmat vaqtincha mavjud emas. Iltimos, birozdan keyin qayta urinib ko‘ring.";
            break;
          default:
            description;
        }
