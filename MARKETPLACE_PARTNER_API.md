...
**Ilova A qo'shildi** — BeePost qabul qiladigan SOATO kodlarining to'liq
ro'yxati (14 viloyat, 207 tuman/shahar). Ma'lumotnoma rasmiy SOATO tasnifi
bilan solishtirilib **to'ldirildi**: avval yetishmayotgan 26 ta yozuv,
jumladan Namangan, Termiz, Urganch, Nukus, Guliston va Farg'ona
**shaharlari** qo'shildi.
...
**Hozirgi holat:** 14 viloyat · **207 tuman/shahar** — O'zbekiston bo'ylab
to'liq qamrov.
...
### ⚠️ TUMAN va SHAHAR — alohida kodlar

Ko'p viloyatda markaziy shahar va shu nomdagi tuman **alohida** yozuv:

| Kod | Nomi | Nima |
|---|---|---|
| `1735225` | Nukus | **tuman** (shahar atrofi) |
| `1735401` | Nukus shahri | **shahar** |
| `1733217` | Urganch | **tuman** |
| `1733401` | Urganch shahri | **shahar** |

Adashtirilsa posilka qo'shni hududga ketadi va hech qanday xato chiqmaydi.
SOATO'da **5-raqam `4` bo'lsa — bu shahar** (`1735`**4**`01`).
...
#### Jizzax viloyati — `1708` (13 ta)

| Kod | Tuman / shahar | Kod | Tuman / shahar |
|---|---|---|---|
| `1708201` | Arnasoy | `1708204` | Baxmal |
| `1708209` | G'allaorol | `1708212` | Sh.Rashidov tumani |
| `1708215` | Dostlik | `1708218` | Zomin tumani |
...
#### Qashqadaryo viloyati — `1710` (16 ta)
...
| `1710245` | Shahrisabz tumani | `1710250` | Yakkabog' |
| `1710401` | Qarshi shahri | `1710405` | Shahrisabz |

#### Navoiy viloyati — `1712` (11 ta)

| Kod | Tuman / shahar | Kod | Tuman / shahar |
|---|---|---|---|
| `1712211` | Konimex tumani | `1712216` | Qiziltepa tumani |
| `1712230` | Navbahor tumani | `1712234` | Karmana tumani |
| `1712238` | Nurota tumani | `1712244` | Tomdi tumani |
| `1712248` | Uchquduq tumani | `1712251` | Xatirchi |
| `1712401` | Navoiy shahri | `1712408` | Zarafshon shahri |
| `1712412` | G'ozg'on tumani |  |  |

#### Namangan viloyati — `1714` (12 ta)
...
| `1714229` | Uychi tumani | `1714234` | Uchqo'rg'on |
| `1714236` | Chortoq | `1714237` | Chust |
| `1714242` | Yangiqo'rg'on | `1714401` | Namangan shahri |
...
#### Surxondaryo viloyati — `1722` (15 ta)
...
| `1724401` | Guliston shahri | `1724410` | Shirin |
| `1724413` | Yangier | `1724414` | Baxt shahri |
...
| `1727250` | Piskent | `1727253` | O'rtachirchiq tumani |
| `1727256` | Chinoz | `1727259` | Yangiyo'l |
| `1727265` | Toshkent tumani | `1727401` | Nurafshon |
| `1727404` | Olmaliq | `1727407` | Angren |
| `1727413` | Bekobod shahri | `1727415` | Ohangaron shahri |
| `1727419` | Chirchiq | `1727424` | Yangiyo'l shahri |

#### Farg'ona viloyati — `1730` (19 ta)

| Kod | Tuman / shahar | Kod | Tuman / shahar |
|---|---|---|---|
| `1730203` | Oltiariq | `1730206` | Qo'shtepa tumani |
| `1730209` | Bog'dod | `1730212` | Buvayda |
| `1730215` | Beshariq | `1730218` | Quva |
| `1730221` | Uchko'prik | `1730224` | Rishton |
| `1730226` | So'x | `1730227` | Toshloq |
| `1730230` | O'zbekiston tumani | `1730233` | Farg'ona |
| `1730236` | Dang'ara | `1730238` | Furqat |
| `1730242` | Yozyovon | `1730401` | Farg'ona shahri |
| `1730405` | Qo'qon | `1730408` | Quvasoy shahri |
| `1730412` | Marg'ilon |  |  |

#### Xorazm viloyati — `1733` (13 ta)

| Kod | Tuman / shahar | Kod | Tuman / shahar |
|---|---|---|---|
| `1733204` | Bog'ot | `1733208` | Gurlan |
| `1733212` | Qo'shko'pir | `1733217` | Urganch |
| `1733220` | Hazorasp | `1733221` | Tuproqqal'a tumani |
| `1733223` | Xonqa tumani | `1733226` | Khiva |
| `1733230` | Shovot | `1733233` | Yangiariq |
| `1733236` | Yangibozor | `1733401` | Urganch shahri |
| `1733406` | Xiva shahri |  |  |

#### Qoraqalpog'iston Respublikasi — `1735` (17 ta)

| Kod | Tuman / shahar | Kod | Tuman / shahar |
|---|---|---|---|
| `1735204` | Amudaryo | `1735207` | Beruniy |
| `1735209` | Bo'zatov tumani | `1735211` | Qorao'zak |
| `1735212` | Kegeyli | `1735215` | Qo'ng'irot |
| `1735218` | Qanliko'l | `1735222` | Mo'ynoq |
| `1735225` | Nukus | `1735228` | Taxiatosh tumani |
