...
| **[14-marketplace-beepost.md](14-marketplace-beepost.md)** | **Yangi marketplace'ni BeePost'ga ulash** (2026-09-15) — SOURCE roli: skan bilan qabul · status sinxroni · **kassa sinxroni** · **ko'p sotuvchi** attributsiyasi. 116 topilma asosida. Kontrakt: [`MARKETPLACE_PARTNER_API.md`](../../MARKETPLACE_PARTNER_API.md) | **REJA — tasdiq kutilmoqda** |
